...
1. **_camilladsp-setrate_ automatically updates the sample rate of Henrik Enquist's [CamillaDSP](https://github.com/HEnquist/camilladsp) when the sample rate of the audio stream being captured changes.**
